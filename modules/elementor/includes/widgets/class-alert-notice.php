...
namespace ShopMaker\Elementor\Widgets;
 ...
 */
class Alert_Notice extends Base {
	...
	public function get_title() {
		return esc_html__( 'Alert Mishu', 'elementor' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'__section_alert',
			[
				'label' => esc_html__( 'Alert Mishu', 'elementor' ),
			]
		);
